"""
    ...
    Sorted By: Ref
    Fields: Ref, Qnty, Value, Cmp name, Footprint, Description, Vendor, ComponentPurchaseUrl, FootprintPurchaseUrl

    Command line:
    python "pathToFile/bom_csv_grouped_by_value_with_component_and_fp.py" "%I" "%O-bom.csv"
"""
...
out.writerow(['Ref', 'Qnty', 'Value', 'Cmp name', 'Cmp Purchase', 'Footprint', 'Footprint Purchase', 'Description', 'Vendor'])
...
for group in grouped:
    ...
    out.writerow([refs, len(group),
        ...
        fromNetlistText( c.getField("ComponentPurchaseUrl") ),
        fromNetlistText( c.getFootprint() ),
        fromNetlistText( c.getField("FootprintPurchaseUrl") ),
